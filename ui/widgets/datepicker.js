...
$.extend( Datepicker.prototype, {
	 ...
	 */
	formatDate: function( format, date, settings,yearOffSet ) {
		if ( !date ) {
			return "";
		}
			...
			offsetString = function( offset ) {
				try {
					return $.datepicker.parseDate( $.datepicker._get( inst, "dateFormat" ),
						offset, $.datepicker._getFormatConfig( inst ) ,$.datepicker._yearOffset(a));
				}
				catch ( e ) {
   ...
   _yearOffset: function (date) {
	if (this._get(date, "isBuddhist")) return 543; return 0
  },
		...
		if ( !inst.yearshtml ) {
			...
			if ( secondary || !changeYear ) {
				...
				for ( ; year <= endYear; year++ ) {
					inst.yearshtml += "<option value='" + (year+this._yearOffset(inst)) + "'" +
